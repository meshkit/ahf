...
#CC="/mathworks/hub/sol2/apps/SUNWspro_studio11_20070319/opt/SUNWspro/bin/cc"  # sol64
	...
	NETCDF="/sandbox/johne/3p-tmw/3p/install/unknown/sol64/netcdf"
    NETCDF="/home/johne/local/sol64"
    NETCDF="/home/johne/local/glnxa64"
    #EXTRA_CFLAGS="-DMATLAB_MEX_FILE -m64 -xarch=sparcvis  -dalign -xlibmieee -D__EXTENSIONS__ -D_POSIX_C_SOURCE=199506L -mt -KPIC  -DSOL64 -DARCH_SOL64 -xO3 -xlibmil -I${NETCDF}/include"   # sol64
