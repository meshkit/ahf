...
MAKEFILE = inverse_mixed_elements_mex.mk

include inverse_mixed_elements_mex.mki
...
MEX_FILE_NAME_WO_EXT = inverse_mixed_elements
...
SYS_INCLUDE += -I "/Users/vladimir/projects/BitBucket/NumGeom/IO/Meshes/mexCGNS/codegen/mex/inverse_mixed_elements"
...
%.$(OBJEXT) : /Users/vladimir/projects/BitBucket/NumGeom/IO/Meshes/mexCGNS/codegen/mex/inverse_mixed_elements/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/vladimir/projects/BitBucket/NumGeom/IO/Meshes/mexCGNS/codegen/mex/inverse_mixed_elements/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
