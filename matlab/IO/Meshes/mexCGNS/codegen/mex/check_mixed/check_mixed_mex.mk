...
MAKEFILE = check_mixed_mex.mk

include check_mixed_mex.mki
...
MEX_FILE_NAME_WO_EXT = check_mixed
...
SYS_INCLUDE += -I "/Users/vladimir/projects/BitBucket/NumGeom/IO/Meshes/mexCGNS/codegen/mex/check_mixed"
...
%.$(OBJEXT) : /Users/vladimir/projects/BitBucket/NumGeom/IO/Meshes/mexCGNS/codegen/mex/check_mixed/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/vladimir/projects/BitBucket/NumGeom/IO/Meshes/mexCGNS/codegen/mex/check_mixed/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
