...
#include "determine_sibling_halffaces_pyramid.h"
#include "stdio.h"
...
void determine_sibling_halffaces_pyramid(int32_T nv, const emxArray_int32_T
  *elems, const emxArray_int32_T *varargin_1, emxArray_int32_T *sibhfs)
{
  ...
  int32_T ii;
  emxArray_int32_T *r0;
  emxArray_int32_T *hf_pyr;
  boolean_T exitg2;
  int32_T jj;
  int32_T nvpf;
  static const int8_T b_hf_pyr[20] = { 1, 1, 2, 3, 4, 4, 2, 3, 4, 1, 3, 5, 5, 5,
    5, 2, 0, 0, 0, 0 };
  ...
  while ((exitg2 == 0U) && (ii + 1 <= nelems)) {
    if (elems->data[ii] == 0) {
      ...
      for (jj = 0; jj < 5; jj++) {
        nvpf = (1 + jj == 1) + 2;
        i0 = hf_pyr->size[0];
        hf_pyr->size[0] = nvpf + 1;
        emxEnsureCapacity((emxArray__common *)hf_pyr, i0, (int32_T)sizeof
                          (int32_T));
        for (i0 = 0; i0 <= nvpf; i0++) {
          hf_pyr->data[i0] = b_hf_pyr[jj + 5 * i0];
        }
  ...
  ii = 0;
  emxInit_int32_T(&c_hf_pyr, 1);
  while (ii + 1 <= nelems) {
    for (jj = 0; jj < 5; jj++) {
      nvpf = (1 + jj < 4);
      i0 = c_hf_pyr->size[0];
      c_hf_pyr->size[0] = nvpf + 3;
      emxEnsureCapacity((emxArray__common *)c_hf_pyr, i0, (int32_T)sizeof
                        (int32_T));
      loop_ub = nvpf + 2;
      for (i0 = 0; i0 <= loop_ub; i0++) {
        c_hf_pyr->data[i0] = b_hf_pyr[jj + 5 * i0];
      }
      ...
      v2hf_lfid->data[is_index->data[mtmp] - 1] = (int8_T)(1 + jj);
      is_index->data[mtmp]++;
    }
  ...
  while (ii + 1 <= nelems) {
    for (jj = 0; jj < 5; jj++) {
      if (sibhfs->data[ii + sibhfs->size[0] * jj] != 0) {
        ...
        nvpf = (jj + 1 == 1);
        i0 = d_hf_pyr->size[0];
        d_hf_pyr->size[0] = nvpf + 3;
        emxEnsureCapacity((emxArray__common *)d_hf_pyr, i0, (int32_T)sizeof
                          (int32_T));
        loop_ub = nvpf + 2;
        for (i0 = 0; i0 <= loop_ub; i0++) {
          d_hf_pyr->data[i0] = b_hf_pyr[jj + 5 * i0];
        }
...
void determine_sibling_halffaces_pyramid_initialize(void)
{
  rt_InitInfAndNaN(8U);
}

void determine_sibling_halffaces_pyramid_terminate(void)
{
}
