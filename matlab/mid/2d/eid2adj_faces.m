function [flist, nfaces, ftags]=eid2adj_faces(eid,edges,tris,v2he,sibhes,ftags,varargin)
%#codegen -args {int32(0), coder.typeof(int32(0), [inf,2]),coder.typeof(int32(0), [inf,3]),
%#codegen coder.typeof(int32(0), [inf,1]),coder.typeof(int32(0), [inf,3]),coder.typeof(false, [inf,1])}
...
%#codegen struct('fid',coder.typeof(int32(0), [inf,3]),'leid',coder.typeof(int8(0), [inf,3])),,
...
if nargin<7 || isempty(varargin{1}) || ~islogical(varargin{1})
    ...
    if (heid.fid==0);  flist=int32(0); return;   end;
end    
...
if nargin<7 || isempty(varargin{1}) || ~islogical(varargin{1})
    ...
    helist.fid=zeros(20,1);   helist.leid=zeros(20,1);
