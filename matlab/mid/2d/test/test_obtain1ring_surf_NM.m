function passed=test_obtain1ring_surf_NM()
...
vid=1;
[ngbvs, nverts, vtags, ftags, ngbfs, nfaces] = obtain_1ring_surf_NM(vid, test_mesh, sibhes, v2he, [], vtags, ftags, []);
passed=nverts==3;
...
passed=passed&&(ngbvs==0);

passed=passed&&(ngbfs==0);
