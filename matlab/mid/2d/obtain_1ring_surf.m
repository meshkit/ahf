function [ngbvs, nverts, ngbes, nfaces] = obtain_1ring_surf( vid, ...
    tris, sibhes, v2he, ngbvs, ngbes) %#codegen
%OBTAIN_1RING_SURF Collect 1-ring neighbor vertices.
% [NGBVS,NVERTS,NGBES,NFACES] = OBTAIN_1RING_SURF(VID,TRIS,SIBHES,V2HE, ...
...
if nargout > 2
    [ngbvs, nverts, vtags, etags, ngbes, nfaces] = obtain_nring_surf...
        ( vid, 1, int32(0), tris, sibhes, v2he, ngbvs, vtags, etags, ngbes); %#ok<ASGLU>
else
    [ngbvs, nverts] = obtain_nring_surf( vid, 1, int32(0), tris, sibhes, v2he, ngbvs);
end
