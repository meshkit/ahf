function [nv_out, nf_out, tris, sibhes] = split_vert_surf(heid_dst, heid_org, ...
    nv_in, nf_in, tris, sibhes, v2he) %#codegen 
%SPLIT_VERT_SURF    Split a vertex into two vertices.
%
%   [NV, NF, TRIS, SIBHES] = SPLIT_VERT_SURF...
%   (HEID_DST, HEID_ORG, NV, NF, TRIS, SIBHES, V2HE) splits the 
...
%   TRIS and SIBHES must be of size Mx2 with M>NF_IN+1, and V2HE 
