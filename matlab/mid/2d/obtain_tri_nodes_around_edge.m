function [nds_redge,nmbn,num1,num2]=obtain_tri_nodes_around_edge(edge,opphes,...
    tris,v2he,nds_redge) %#codegen 
ngbes1=nullcopy(zeros(128,1,'int32'));
ngbes2=nullcopy(zeros(128,1,'int32'));
[ngbvs1, num1] = obtain_1ring_surf( edge(1), tris, opphes, v2he, ...
                    nds_redge,ngbes1);
[ngbvs2, num2] = obtain_1ring_surf( edge(2), tris, opphes, v2he, ...
                    nds_redge,ngbes2);
nmbn=num1+num2-4;
count=int32(0);
